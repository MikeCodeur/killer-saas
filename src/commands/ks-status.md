...
2. Stories: list the ids from docs/stories.md. For each id:
   ...
   - design: docs/designs/<id>.md exists? (meaningful for UI stories only)
...
3. Print a compact table: story | research | design | plan (x/y tasks) | review | shipped | next command for that story.
